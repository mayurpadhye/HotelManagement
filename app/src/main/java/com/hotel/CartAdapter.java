...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.ViewHolder> {
    ...
    Context context;
    List<CartPojo> itemListPojoList;

    public CartAdapter(Context context, List<CartPojo> itemListPojoList) {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        final CartPojo items = itemListPojoList.get(position);
        holder.tv_item_name.setText(items.getItem_name());

        //holder.imageView.setImageResource(listdata[position].getImgId());

        holder.tv_ingredients.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                openItemDetailsBottomSheet(items.getItem_id(),items.getItem_name(),items.getItem_image(),items.getItem_ingredients(),position);
            }
        });
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tv_price,tv_item_name,tv_ingredients;
